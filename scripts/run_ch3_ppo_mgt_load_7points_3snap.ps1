# Chapter 3 PPO-MGT official load test script
...
# 用法：powershell -ExecutionPolicy Bypass -File "D:\any download\virne-main\virne-main\scripts\run_ch3_ppo_mgt_load_7points_3snap.ps1"

$repo = "D:\any download\virne-main\virne-main"
$python = "D:\anaconda\envs\virne-main\python.exe"
$model = "D:\any download\virne-main\virne-main\results\virne_ch3\ppo_gat_seq2seq+\DESKTOP-2NM5LP6-20260526T165819-1245\models\model.pkl"
$rates = @("0.003", "0.006", "0.009", "0.012", "0.015", "0.018", "0.021")

$timestamp = Get-Date -Format "yyyyMMdd_HHmmss"
$logDir = Join-Path $repo "overnight_logs\ch3_ppo_mgt_load_7points_10snap_$timestamp"
New-Item -ItemType Directory -Force -Path $logDir | Out-Null

Set-Location -LiteralPath $repo

Write-Host "============================================================"
Write-Host "Chapter 3 PPO-MGT official load test started"
...
Write-Host ""
Write-Host "============================================================"
Write-Host "All PPO-MGT official load tests finished"
Write-Host "日志目录: $logDir"
Write-Host "============================================================"
